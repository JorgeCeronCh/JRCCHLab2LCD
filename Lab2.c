...
void __interrupt() isr (void){
    ...
    if(PIR1bits.ADIF){                      
        ...
        else if (ADCON0bits.CHS == 1){ // Interrupción por AN0
    ...
    while(1)
    {
        ...
        switch(MOSTRAR){
            case 0:                     //
                ...
                Lcd8_Set_Cursor(1,1);
                Lcd8_Write_String("POT1");
                Lcd8_Set_Cursor(2,1);
                Lcd8_Write_String(VALORES1);
                break;
            case 1:                     // 
                Lcd8_Set_Cursor(1,1);
                Lcd8_Write_String("POT2");
                Lcd8_Set_Cursor(2,1);
...
void setup(void){       
    ...
    ANSEL = 0b00000011;         // AN0 y AN1 como I/O analógica
    ANSELH = 0b00000000;        // I/O digitales
    TRISA = 0b00000011;         // RA0 y RA1 como entrada, demás como salida
    TRISC = 0b00000000;
